...
def info(file_location):
    ...
    while True:
        ...
        info_choice = input("What information would you like to know? (N for column names, H for head of a variable, T for tail of a variable, M for mean of variable, main to go back to covid_project.py) ")
